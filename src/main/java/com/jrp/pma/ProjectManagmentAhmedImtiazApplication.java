...
public class ProjectManagmentAhmedImtiazApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(ProjectManagmentAhmedImtiazApplication.class, args);
    }
    ...
    CommandLineRunner runner() {
        return args -> {
            ...
            List<Employee> employe_for_same_project1 = new ArrayList<>();
            employe_for_same_project1.add(emp1);
            employe_for_same_project1.add(emp2);
            pro1.setEmployees(employe_for_same_project1);

            List<Employee> employe_for_same_project2 = new ArrayList<>();
            employe_for_same_project2.add(emp3);
            pro2.setEmployees(employe_for_same_project2);

            List<Employee> employe_for_same_project3 = new ArrayList<>();
            employe_for_same_project3.add(emp1);
            pro3.setEmployees(employe_for_same_project3);

            List<Employee> employe_for_same_project4 = new ArrayList<>();
            employe_for_same_project4.add(emp1);
            employe_for_same_project4.add(emp3);
            pro4.setEmployees(employe_for_same_project4);
...
//            pro4.addEmployee(emp3);
            ...
            List<Project> projs1 = new ArrayList<>();
            projs1.add(pro1);
            projs1.add(pro3);
            projs1.add(pro4);
            emp1.setProjects(projs1);

           List<Project> projs2 = new ArrayList<>();
            projs2.add(pro1);
            emp2.setProjects(projs2);

            List<Project> projs3 = new ArrayList<>();
            projs3.add(pro2);
            projs3.add(pro4);
            emp3.setProjects(projs3);
